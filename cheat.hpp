...
// NeoRed v6 (Unity 6 / 2026-06-08) bone indices. The rig has 94 bones in
// this build and the indices below were live-probed via Model.boneNames.
// Indices that aren't critical for ESP/aim are left as sequential
// placeholders (the only ones the cheat actually reads are pelvis, l_hip,
// l_knee, l_foot, r_hip, r_knee, r_foot, spine2, spine4, l_clavicle,
// l_upperarm, l_forearm, l_hand, r_clavicle, r_upperarm, r_forearm, r_hand,
// neck, head). The remaining identifiers keep their original placement so
// any compile-time references compile cleanly.
enum BoneList : int
{
	pelvis = 0,           // [PROBED]
	l_hip = 1,            // [PROBED]
	l_knee = 3,           // [PROBED] (was 2)
	l_foot = 4,           // [PROBED] (was 3)
	l_toe = 5,
	l_ankle_scale = 6,
	penis = 7,
	GenitalCensor = 8,
	...
	GenitalCensor_LOD3 = 13,
	r_hip = 14,           // [PROBED] (was 13)
	r_knee = 16,          // [PROBED] (was 14)
	r_foot = 17,          // [PROBED] (was 15)
	r_toe = 18,
	r_ankle_scale = 19,
	spine1 = 20,
	spine2 = 21,          // [PROBED] (was 19)
	spine3 = 22,
	spine4 = 23,          // [PROBED] (was 21)
	spine1_scale = 100,   // unused / out-of-range placeholder
	l_clavicle = 24,      // [PROBED] (was 22)
	l_upperarm = 25,      // [PROBED] (was 23)
	l_forearm = 26,       // [PROBED] (was 24)
	l_hand = 29,          // [PROBED] (was 25)
	l_index1,
	l_index2,
	l_index3,
	l_little1,
	...
	l_thumb2,
	l_thumb3,
	IKtarget_righthand_min = 49,
	IKtarget_righthand_max = 50,
	l_ulna = 51,
	neck = 52,            // [PROBED] (was 44)
	head = 53,            // [PROBED] (was 45)
	jaw = 54,
	eyeTranform = 55,
	l_eye = 56,
	l_Eyelid = 57,
	r_eye = 58,
	r_Eyelid = 59,
	r_clavicle = 60,      // [PROBED] (was 53)
	r_upperarm = 61,      // [PROBED] (was 54)
	r_forearm = 62,       // [PROBED] (was 55)
	r_hand = 65,          // [PROBED] (was 56)
	r_index1,
	r_index2,
	r_index3,
	r_little1,
