...
static void ImGui::UpdateMouseInputs()
{
    ...
    g.IO.MouseDown[0] = ( GetAsyncKeyState ( VK_LBUTTON ) & 0x8000 ) != 0;
    g.IO.MouseDown[1] = ( GetAsyncKeyState ( VK_RBUTTON ) & 0x8000 ) != 0;
    g.IO.MouseDown[2] = ( GetAsyncKeyState ( VK_MBUTTON ) & 0x8000 ) != 0;
