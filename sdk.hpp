...
namespace rust {
	...
	uintptr_t get_local_player_static ( CSharedMemComms* drv );
	...
	Vector3 get_entity_world_position ( CSharedMemComms* drv, uintptr_t entity );
	...
	// Robust IL2CPP-based camera resolver: scans MainCamera class' static fields
	// for a slot whose pointer dereferences to UnityEngine.Camera and stores the
	// result in addr::camera_instance. Returns the resolved instance (or 0).
	uintptr_t resolve_main_camera ( CSharedMemComms* drv );
